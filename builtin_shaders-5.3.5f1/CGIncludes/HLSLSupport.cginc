...
#define UNITY_UV_STARTS_AT_TOP 1 //值 1 在纹理 V 坐标在“纹理顶部”为零的平台上 OpenGL 的平台使用值 0
#endif
...
#define UNITY_NEAR_CLIP_VALUE (0.0)//近裁剪平面的值
#else
#define UNITY_NEAR_CLIP_VALUE (-1.0)//近裁剪平面的值
#endif
